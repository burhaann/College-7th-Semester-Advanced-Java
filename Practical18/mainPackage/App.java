...
class App{
    public static void main(String[] args) {
        ...
        file.add(fileNew);   file.add(fileOpen);   file.add(fileSave);   file.add(fileSaveAs);   file.add(fileExit);;

        JMenu edit = new JMenu("Edit");
        JMenu help = new JMenu("Help");
        JMenu exit = new JMenu("Exit");

        menuBar.add(file);  menuBar.add(edit);  menuBar.add(help);  menuBar.add(exit);
