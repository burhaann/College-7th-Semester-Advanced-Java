...
class App{
    public static void main(String[] args) throws Exception {
        ...
        JTextField txtField1 = new JTextField();        txtField1.setColumns(10);
        JTextField txtField2 = new JTextField();        txtField2.setColumns(10);
        JTextField txtResult = new JTextField();        txtResult.setColumns(10);        txtResult.setEnabled(false);

        //Declaring Panel to hold all Textfields and Layout to keep them in a row
        JPanel textPanel = new JPanel(new FlowLayout());
        textPanel.add(txtField1);        textPanel.add(txtField2);        textPanel.add(txtResult);
        ...
        butPanel.add(butAdd);  butPanel.add(butSub);        
        butPanel.add(butMul);  butPanel.add(butDiv);
